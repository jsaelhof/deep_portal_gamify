                    ...
                    <div className="panel panel-default">
                        <div className="panel-heading">
                            <div className="panel-heading-label">
                                <h1>
                                    Your DeepMarkit App Code
                                </h1>
                                <h3 className="subheading">Integrate your new campaign into the pages of your site</h3>
                            </div>
                        </div>
                        <div className="panel-body">
                            
                            <div className="code-integration">
                                <div className="code_snippet_pod m-t-2 m-b-14"> 
                                    <div><String code="label_code_integration_code_desc"/></div>
                                    <div className="m-t-4 m-b-4 code_snippet_box">
                                        <pre>{codeSnippet}</pre>
                                    </div>
...

                                {
                                    ...
                                    ConfigStore.INTEGRATION === "gamify" ? 
                                        this.state.guides ?
                                            <div className="integration-guides_pod m-b-8">
                                                <div className="m-b-2"><h4><String code="label_code_integration_guide_header"/></h4></div>
                                                ...
                                                <div className="deepmarkit-guide m-t-4 m-b-4">
                                ...
                                {/* <div className="m-b-4">
                                    <div className="m-b-6"><h4><String code="label_code_integration_help_header"/></h4></div>
                                    <div className="form-group m-t-4">
